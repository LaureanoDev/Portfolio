  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Link href="/">
          <h1 className="text-transparent bg-clip-text bg-gradient-to-r from-[#72f] to-[#c1b] cursor-pointer">LP</h1>
        </Link>
        <div>
        ...
        >
          <div>
            <div className="flex w-full items-center justify-between">
              ...
              <div
                onClick={handleNav}
                className="rounded-full shadow-lg shadow-gray-400 p-3 cursos-pointer"
              >
                <AiOutlineClose />
              </div>
            </div>
